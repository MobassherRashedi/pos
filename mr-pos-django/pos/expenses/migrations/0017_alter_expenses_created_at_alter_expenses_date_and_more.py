...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('expenses', '0016_alter_expenses_created_at_alter_expenses_date_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='expenses',
            name='date',
            field=models.DateTimeField(default=datetime.datetime(2022, 12, 31, 2, 12, 46, 135861), null=True),
        ),
        migrations.AlterField(
